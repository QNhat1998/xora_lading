      ...
      <Element name="features">
        <div className="container">
          <div
           ...
           max-md:border-none max-md:round-none max-md:gap-3"
          >
              ...
              >
                <div className="w-full flex justify-start items-start">
                  <div className="-ml-3 mb-12 flex items-center justify-center flex-col">
                    ...
                    <img src={icon} className="size-28 object-contain" alt="" />
                  </div>
                </div>
            ...
            <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
              <div className="absolute bg-s3/20 top-[38%] left-0 right-0 w-full"></div>
              {details.map(({ id, icon, title }) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  <div className="absolute top-8 bottom-0 left-1/2 bg-s3/20 w-[1px] h-full z-10"></div>
